    ...
    <div class="col-md-12">
      <div class="col-md-6 column">
        <div class="panel panel-primary">
          <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;"><span>PATIENT INFORMATION</span></div>
        ...
        <div class="panel panel-primary">
          <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;"><span>DIALYSIS PARAMETERS</span></div>
          <table class="table table-bordered" style="font-size:12px">
            <tbody>
              <tr>
                <td>Dialyzer</td>
        ...
        <div class="panel panel-primary">
          <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;"><span>ANTICOAGULATION</span></div>
          <table class="table table-bordered" style="font-size:12px">
            <tbody>
              <tr>
                <td>Heparin</td>
      ...
      <div class="col-md-6 column">
        ...
        <div class="panel panel-primary">
          <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;"><span>DELIVERY SYSTEM</span></div>
          <table class="table table-bordered" style="font-size:12px">
            <tbody>
              <tr>
                <td>Machine #</td>
        ...
        <div class="panel panel-primary">
          <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;"><span>VASCULAR ACCESS</span></div>
          <table class="table table-bordered" style="font-size:12px">
            <tbody>
              <tr>
        ...
        <div class="panel panel-primary">
          <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;"><span>FLUID MANAGEMENT</span></div>
          <table class="table table-bordered" style="font-size:12px">
            <tbody>
              <tr>
                <td>Weight</td>
