      ...
      <div class="col-md-12">
        <div class="col-md-6 column">
          <div class="panel panel-primary">
            <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;">WAITLIST FOR: {{ $appt_date }}</div>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;">CANCELLED AND FINISHED TREATMENTS: {{ $appt_date }}</div>
            <table class="table table-bordered" style="font-size:12px">
              <thead>
        ...
        <div class="col-md-6 column">
          <div class="panel panel-primary">
            <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;">TODAY'S TREATMENTS</div>
            <table class="table table-bordered" style="font-size:12px">
              <thead>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading" style="padding-left: 10px; padding-right: 10px;">TODAY'S CANCELLED AND FINISHED TREATMENTS</div>
            <table class="table table-bordered" style="font-size:12px">
              <thead>
                <tr><th>#</th><th>Name</th><th>Status</th><th>Link</th></tr>
              </thead>
